...
public class Album {
    ...
    private static void selectionSort(Song[] songs){
        for (int i = 0; i < songs.length; i++) {
    ...
    private static void bubbleSort(Song[] songs){
    ...
    private void insertionSort(Song[] songs2) {
    ...
    public static void reverseArray (Song[]songs){
        int left = 0;
